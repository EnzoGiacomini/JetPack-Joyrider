...
public class MapManager : MonoBehaviour
{
    ...
    {
        int Random_num = UnityEngine.Random.Range(1, 4);
        ...
        for (int i = 0; i < Random_num; i++)
        {
            ...
            if (Random_chance < 0.5f)
            {
                ...
                while (laser_b_instance.transform.localScale.y < 35)
                {
                    ...
                    scale.y = Mathf.Lerp(scale.y, 35.1f, laserSpeed * Time.deltaTime);
    ...
    IEnumerator MissileAlert()
    {
        ...
        while (Targeting)
        {
            ...
            missile_alert_instance.transform.position = Vector2.MoveTowards(missile_alert_instance.transform.position, new Vector2(missile_alert_instance.transform.position.x, Random_place), AlertSpeed * Time.deltaTime);
    ...
    public void SpawnMissile(Vector2 position)
    {
        ...
        missile_instance.GetComponent<Rigidbody2D>().AddForce(new Vector2(-missileSpeed * Time.deltaTime, 0), ForceMode2D.Impulse);
    }
    ...
    public void SpawnBomb(Vector2 position)
    {
        ...
        bomb_instance.GetComponent<Rigidbody2D>().AddForce(Vector2.left * bomb_speed * Time.deltaTime, ForceMode2D.Impulse);
    }
    ...
    IEnumerator VerticalLaserMiddle()
    {
        ...
        while (vertical_laser_up.transform.position.x > -17)
        {
            ...
            vertical_laser_up_instance.transform.position = Vector2.MoveTowards(vertical_laser_up_instance.transform.position, new Vector2(-17.1f, vertical_laser_up_instance.transform.position.y), vertical_laser_speed * Time.deltaTime);
            vertical_laser_down_instance.transform.position = Vector2.MoveTowards(vertical_laser_down_instance.transform.position, new Vector2(-17.1f, vertical_laser_down_instance.transform.position.y), vertical_laser_speed * Time.deltaTime);
            vertical_laser_b_instance.transform.position = Vector2.MoveTowards(vertical_laser_b_instance.transform.position, new Vector2(-17.1f, vertical_laser_b_instance.transform.position.y), vertical_laser_speed * Time.deltaTime);
        }
